...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private static int PICK_IMAGE = 123;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            Email = findViewById(R.id.etUserEmailUpdate);
            Age = findViewById(R.id.age);
            Gender = findViewById(R.id.gender);
            Password = findViewById(R.id.etUserPassword);
            Button regButton = findViewById(R.id.btnSave);
            Username = findViewById(R.id.etUsernameUpdate);
            UserProfilePic = findViewById(R.id.imPP);
                        ...
                        firebaseAuth.createUserWithEmailAndPassword(User_Email,User_Password).addOnCompleteListener(new OnCompleteListener<AuthResult>(){
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task){
                                if(task.isSuccessful()){
                                    ...
                                    Toast.makeText(com.example.churros2.RegistrationActivity.this, "Regeistration Failed", Toast.LENGTH_SHORT).show();
                                }
                            }
                        });
                    }
        ...
        private Boolean validate(){
            ...
            if(Name.isEmpty() || UserEmail.isEmpty() || userpassword.isEmpty() || imagePath == null ){
            ...
            if(firebaseUser != null){
                firebaseUser.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful()){
                            sendUserData();
                            Toast.makeText(com.example.churros2.RegistrationActivity.this, "Successfully Registered, Verification Email has been sent!", Toast.LENGTH_SHORT).show();
                            //Signs the user out of the app
                            firebaseAuth.signOut();
                            finish();
                            startActivity(new Intent(com.example.churros2.RegistrationActivity.this, MainActivity.class));
                        }else{
                            Toast.makeText(com.example.churros2.RegistrationActivity.this,"Verification Email hasn't been sent!!", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
        ...
        private void sendUserData(){
            ...
            uploadTask.addOnFailureListener(new OnFailureListener() {
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(com.example.churros2.RegistrationActivity.this, "Upload Failed", Toast.LENGTH_SHORT).show();
                }
            }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                @Override
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(com.example.churros2.RegistrationActivity.this, "Upload Successfully", Toast.LENGTH_SHORT).show();
                }
            });
